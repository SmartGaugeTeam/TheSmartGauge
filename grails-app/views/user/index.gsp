		...
		<div id="list-user" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="LGA" title="${message(code: 'user.LGA.label', default: 'LGA')}" />
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${userInstance.id}">${fieldValue(bean: userInstance, field: "LGA")}</g:link></td>
